...
class ArticleController extends Controller
{
    ...
    public function homeAction(){
        return $this->render('EsieaBlogBundle:Article:home.html.twig');
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EsieaBlogBundle:Article')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EsieaBlogBundle:Article')->find($id);
        ...
        return $this->render('EsieaBlogBundle:Article:show.html.twig', array(
            'entity'      => $entity,
